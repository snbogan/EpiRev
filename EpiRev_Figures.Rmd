...
overlap_df <- data.frame(
  Study = c("Saban_etal_2020","Johnson_etal_2021", 
            ...
            "Rohr_etal_2021", "Lindner_etal_2021", 
...
ggplot(data = overlap_df,
  ...
  geom_jitter(height = 0.1, width = 0, size = 2.5, alpha = 0.5, color = "white") +
  geom_point(data = overlap_sum, size = 4, color = "white") +
  geom_errorbar(data = overlap_sum, 
                aes(xmin = Prop - ci, xmax = Prop + ci), 
                width = 0, size = 1, color = "white") +
  #theme_classic(base_size = 15) +
  labs(x = "Proportion DM associated with DE") +
